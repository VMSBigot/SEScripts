...
namespace IngameScript
{
    partial class Program : MyGridProgram
    {
        ...
        string VERSION = "003"; //Script Version
        ...
        void MiningLogic(IMyRemoteControl RC, List<Vector3D> DOCK_ROUTE, IMyGyro GYRO, IMyShipConnector CONNECTOR, bool RESET)
        {
            ...
            bool IsMassAboveThreshold = (Me.CubeGrid.ToString().Contains("Large")) ? SHIP_DRILLS[0].GetInventory().CurrentMass > 60000 : SHIP_DRILLS[0].GetInventory().CurrentMass > 9000;
